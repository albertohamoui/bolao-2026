#!/usr/bin/env python3
"""
Otimizador de calibração via grid search sobre o backtest da Copa 2022.
...
Uso:
    ...
    python3 backtests/wc2022/optimize.py --quick   # grid reduzido (~50 combos)
"""
...
from run_backtest import make_calibration_2022, run_backtest
...
def main():
    ...
    print("=" * 70)
    print("  OTIMIZADOR DE CALIBRAÇÃO — Copa 2022 (dados de época)")
    print("=" * 70)
...
def _auto_save_results(results: list):
    ...
    path = os.path.join(save_dir, "optimize_2022.json")
    serializable = []
    for r in results:
